...
contract('LabStartICO', (accounts) => {
   ...
   it("The finalize should burn the remaining Labcoins", () => {
        ...
        .then(function(icoBalance) {
           ...
           new BigNumber(8400000000000000000000000).valueOf(),
            "The balance of the ico should be 8400000 LabCoin");
        ...
        .then(function() {
            ...
            assert.equal(walletBalanceAfterFinalize.valueOf(), 84000,
            "The team wallet should have 84000 eth");
            return _tokenInstance.balanceOf(_icoInstance.address)
        })
        .then(function(icoBalance) {
           assert.equal(icoBalance.valueOf(),
        ...
        .then(function(teamLabCoinBalance) {
            ...
            assert.equal(precisionRound((labcoinsSoldDuringPresale.add(labcoinsSoldDuringICO)).add(teamLabCoinBalance).valueOf(), 5),
            precisionRound((5*teamLabCoinBalance).valueOf(), 5),
